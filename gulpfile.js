...
gulp.task('watch', function() {
  gulp.watch(['js/var.js', 'js/helpers.js', 'js/create.js',  'js/loadjson.js', 'js/preloader.js', 'js/playlist.js', 'js/video.js', 'js/getslides.js', 'js/setslide.js', 'js/setsize.js', 'js/config.js', 'css/video-js.css', 'css/slidemecss.css'], ['lint', 'scripts'], 'minify-css');
});
